...
$fuentes = [
    'ComprasProyectadas.php' => __DIR__ . '/../cashflow/Class/ComprasProyectadas.php',
    'ComprasProyectadasDatos.php' => __DIR__ . '/../cashflow/Class/ComprasProyectadasDatos.php'
];
...
$datos = preg_replace('#/\*.*?\*/#s', '',
    file_get_contents(__DIR__ . '/../cashflow/Class/ComprasProyectadasDatos.php'));
