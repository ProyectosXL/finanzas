...
require_once __DIR__ . '/../cashflow/Class/Fondos.php';
...
$fuente = file_get_contents(__DIR__ . '/../cashflow/Class/Providers/FondosProvider.php');
...
$tabSaldos = file_get_contents(__DIR__ . '/../cashflow/Tabs/saldos.php');
$jsSaldos = file_get_contents(__DIR__ . '/../cashflow/Js/Saldos.js');
$tabParam = file_get_contents(__DIR__ . '/../cashflow/Tabs/parametros_saldos.php');
$jsParam = file_get_contents(__DIR__ . '/../cashflow/Js/Parametros-Saldos.js');
$ctrl = file_get_contents(__DIR__ . '/../cashflow/Controller/SaldosController.php');
