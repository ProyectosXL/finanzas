...
chequear('el controller existe', true,
    file_exists(__DIR__ . '/../' . $modulos['TARJETAS']['endpoint']));
...
$panes = file_get_contents(__DIR__ . '/../Tabs/parametros.php');
...
chequear('el archivo de la sub-pestana existe', true,
    file_exists(__DIR__ . '/../Tabs/parametros_tarjetas.php'));
chequear('y su JS tambien', true,
    file_exists(__DIR__ . '/../Js/Parametros-Tarjetas.js'));
...
$tabTarjetas = preg_replace(['/\/\*.*?\*\//s', '/<!--.*?-->/s'], '',
    file_get_contents(__DIR__ . '/../Tabs/parametros_tarjetas.php'));
...
$jsTarjetas = preg_replace(['/\/\*.*?\*\//s', '/\/\/[^\n]*/'], '',
    file_get_contents(__DIR__ . '/../Js/Parametros-Tarjetas.js'));
