...
$fuente = file_get_contents(__DIR__ . '/../Class/Proveedores.php');
$cuerpoDe = function ($metodo) use ($fuente) {
    $r = new ReflectionMethod('Proveedores', $metodo);

    return implode('', array_slice(file(__DIR__ . '/../Class/Proveedores.php'),
...
/* EL BUG QUE ESTO FIJA: indicadores() se calculaba sobre TODOS los items y la
   ...
   de TOTALES. */
$js = file_get_contents(__DIR__ . '/../Js/Proveedores-Proveedores_locales.js');
...
$ejeJs = file_get_contents(__DIR__ . '/../Js/eje-vistas.js');
...
$htmlProv = file_get_contents(__DIR__ . '/../Tabs/proveedores_locales.php');
...
chequear('el interruptor arranca APAGADO', true,
    preg_match('/id="verExcluidasProv"(?![^>]*\bchecked\b)/',
        file_get_contents(__DIR__ . '/../Tabs/proveedores_locales.php')) === 1);
...
chequear('y el backend le da el numero', true,
    strpos(file_get_contents(__DIR__ . '/../Controller/ProveedoresController.php'),
...
$catRevalida = file_get_contents(__DIR__ . '/../Class/ProveedoresCategorias.php');
...
$catFuente = file_get_contents(__DIR__ . '/../Class/ProveedoresCategorias.php');
...
$tabFuente = file_get_contents(__DIR__ . '/../Tabs/proveedores_locales.php');
...
$tabProv = file_get_contents(__DIR__ . '/../Tabs/proveedores_locales.php');
...
$ctrlProv = file_get_contents(__DIR__ . '/../Controller/ProveedoresController.php');
...
require_once __DIR__ . '/../Class/Providers/ProveedoresProvider.php';
...
$cssProv = file_get_contents(__DIR__ . '/../Css/Proveedores-Proveedores_locales.css');
...
$tabMaestro = file_get_contents(__DIR__ . '/../Tabs/proveedores_locales.php');
