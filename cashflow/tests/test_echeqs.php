...
require_once __DIR__ . '/../Class/Providers/EcheqsProvider.php';
...
$tabEcheqs = file_get_contents(__DIR__ . '/../Tabs/echeqs.php');
$jsEcheqs = file_get_contents(__DIR__ . '/../Js/Ingresos-Echeqs.js');
$ctrlEcheqs = file_get_contents(__DIR__ . '/../Controller/EcheqsController.php');
