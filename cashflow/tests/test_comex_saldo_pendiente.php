...
$comexSrc = codigoSinComentariosSP(__DIR__ . '/../Class/Comex.php');
...
$ctrlSrc = codigoSinComentariosSP(__DIR__ . '/../Controller/ComexController.php');
...
$jsProv = codigoSinComentariosSP(
    __DIR__ . '/../Js/Comex-Proveedores_exterior.js');
$htmlProv = codigoSinComentariosSP(__DIR__ . '/../Tabs/proveedores_exterior.php');
...
$provSrc = codigoSinComentariosSP(
    __DIR__ . '/../Class/Providers/ComexProvider.php');
