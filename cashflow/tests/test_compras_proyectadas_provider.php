...
$provider = __DIR__ . '/../Class/Providers/ComprasProyectadasProvider.php';
$registry = __DIR__ . '/../Class/CashflowRegistry.php';
...
$tab = __DIR__ . '/../Tabs/compras_proyectadas.php';
$js = __DIR__ . '/../Js/Compras-Proyectadas.js';
$ctrl = __DIR__ . '/../Controller/ComprasProyectadasController.php';
$paramTab = __DIR__ . '/../Tabs/parametros_compras_proy.php';
$paramJs = __DIR__ . '/../Js/Parametros-Compras_proy.js';
...
foreach (['la pestana' => $tab, 'su JS' => $js, 'su controller' => $ctrl,
          ...
          'su CSS' => __DIR__ . '/../Css/Compras-Proyectadas.css'] as $que => $ruta) {
    chequear($que . ' existe', true, file_exists($ruta));
}

$menu = file_get_contents(__DIR__ . '/../Class/Menu.php');
...
$parametros = file_get_contents(__DIR__ . '/../Class/Parametros.php');
...
chequear('el tab-pane de Parametros tiene el id que arma la lista',
    true, strpos(file_get_contents(__DIR__ . '/../Tabs/parametros.php'),
