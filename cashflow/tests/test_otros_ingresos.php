...
require_once __DIR__ . '/../Class/Providers/OtrosIngresosProvider.php';
...
foreach (['Tabs/saldo_inversiones.php', 'Tabs/dolares_comitente.php',
    ...
    chequear($archivo . ' ya no existe', false, file_exists(__DIR__ . '/../' . $archivo));
}
...
chequear('y la clase que lee las tablas tambien', true,
    file_exists(__DIR__ . '/../Class/OtrosIngresos.php'));
...
$fuenteProv = file_get_contents(__DIR__ . '/../Class/Providers/OtrosIngresosProvider.php');
