...
require_once __DIR__ . '/../Class/Providers/TarjetasProvider.php';
...
$htmlTarj = preg_replace('/<!--.*?-->/s', '',
    file_get_contents(__DIR__ . '/../Tabs/pagos_tarjetas.php'));
$jsTarj = preg_replace(['/\/\*.*?\*\//s', '/\/\/[^\n]*/'], '',
    file_get_contents(__DIR__ . '/../Js/Financiero-Pagos_tarjetas.js'));
