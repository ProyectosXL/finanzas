...
require_once __DIR__ . '/../Class/CoberturaAutomatica.php';
...
require_once __DIR__ . '/../Class/Providers/CoberturaProvider.php';
...
$cuerpoGuardarAuto = (function () {
    ...
    return implode('', array_slice(file(__DIR__ . '/../Class/Cobertura.php'),
